...
export default function InfoBox ({page}) {
        ...
        switch(page){
            case 'contact':
                return <main key={1} className="pageContent">
            ...
            case 'projects':
                return (<main key={2} className="pageContent">
                            <p className='title'> SOME OF MY WORK..</p>
                        </main>)
            case 'background':
                return (<main key={3} className="pageContent">
